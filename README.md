...
On Fabric 1.20.1 and 1.21.1, discovery messages work but JourneyMap waypoints are not created. Fabric 1.21.4 and newer include the waypoint integration.

## Downloads and support

Downloads: [CurseForge](https://www.curseforge.com/minecraft/mc-mods/compass-to-map) · [GitHub Releases](https://github.com/KURONAMI333/compass-to-map/releases/tag/v2.0.4).

For bugs and questions, comment on the [CurseForge page](https://www.curseforge.com/minecraft/mc-mods/compass-to-map) or DM [@kuronami333 on X](https://x.com/kuronami333).

[Source](https://github.com/KURONAMI333/compass-to-map) · [License](LICENSE)
